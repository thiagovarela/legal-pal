		...
		<nav class="relative z-50 flex justify-between">
			<div class="flex items-center md:gap-x-12">
				<a aria-label="Home" href="/">
					<i class="ri-scales-line ri-3x flex text-blue-600"></i>
				</a>
				<h1 class="text-semibold">Legal Pal</h1>
					...
					<div data-headlessui-state="">
						<button
							...
							><svg
								...
								><path d="M0 1H14M0 7H14M0 13H14" class="origin-center transition"></path><path
									d="M2 2L12 12M12 2L2 12"
									class="origin-center scale-90 opacity-0 transition"
								></path></svg
							></button
						>
					</div>
